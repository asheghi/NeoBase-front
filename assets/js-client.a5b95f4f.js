import{H as o,o as t,c as n,f as s}from"./index.3459ee34.js";const a={class:"markdown-body"},c=s(`<p>this client is an abstraction over our REST APIs, you can learn more about each method in its corresponding API document.</p><h2>Getting Started</h2><p>it\u2019s extremely easy to start working with NeoBase via this client.</p><h4>Create Project</h4><p>if you haven\u2019t registered, create your account at <a href="https://neobase.uk/register">register</a> page. when you\u2019re logged in navigate to <a href="https://neobase.uk/register">dashboard</a>, click on \u201CNew Project\u201D and enter your project name.</p><p>note: project names are unique, so try another one if it was already taken.</p><h2>Install Client</h2><p>to add client on existing project just run the following command to add client to your project dependencies.</p><pre><code class="language-bash">npm i --save @neobase/client
